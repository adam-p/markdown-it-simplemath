...
browserify:
	...
	( printf "/*! ${NPM_PACKAGE} ${NPM_VERSION} ${GITHUB_PROJ} @license MIT */" ; \
		./node_modules/.bin/browserify ./ -s markdownitSimpleMath \
		) > dist/markdown-it-simplemath.js
	# Minify
	./node_modules/.bin/uglifyjs dist/markdown-it-simplemath.js -b beautify=false,ascii-only=true -c -m \
		--preamble "/*! ${NPM_PACKAGE} ${NPM_VERSION} ${GITHUB_PROJ} @license MIT */" \
		> dist/markdown-it-simplemath.min.js
